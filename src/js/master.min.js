...
var httpRequest = exports.httpRequest = function httpRequest(filePath, callBackFn) {
...
var _ContentMenu = __webpack_require__(33);

var _ContentMenu2 = _interopRequireDefault(_ContentMenu);

var _ContactMenu = __webpack_require__(34);
...
(function () {
    ...
    if (contentMenu !== null) {
        (0, _reactDom.render)(_react2.default.createElement(_ContentMenu2.default, null), contentMenu);
    }

    // render contact menu
    var contactMenu = document.getElementById('contact-menu');
    if (contactMenu !== null) {
        (0, _reactDom.render)(_react2.default.createElement(_ContactMenu2.default, null), contactMenu);
    }
})();
...
var _httpRequest = __webpack_require__(13);

var _MenuHeader = __webpack_require__(28);

var _MenuHeader2 = _interopRequireDefault(_MenuHeader);

var _MenuItem = __webpack_require__(32);
...
var Menu = function (_Component) {
    ...
    function Menu(props) {
        ...
        _this.handleMenuRequest = function (responseText) {
            var menuJson = JSON.parse(responseText);
            _this.setState({
                menuLoaded: true,
                menuData: menuJson
            });
        ...
        _this.closeMobileMenu = function () {
    ...
    _createClass(Menu, [{
        ...
        value: function componentDidMount() {
            (0, _httpRequest.httpRequest)("/js/menu.json", this.handleMenuRequest);
        }
    }, {
        key: 'render',
        value: function render() {
            var _state = this.state,
                ...
                menuLoaded = _state.menuLoaded;

            if (!menuLoaded) {
                return null;
            }

            return _react2.default.createElement('div', { className: 'menu' }, _react2.default.createElement(_MenuHeader2.default, { onCloseMobileMenu: this.closeMobileMenu }), _react2.default.createElement('div', { className: 'menu-list' }, menuData.work.map(function (workItem, key) {
                return _react2.default.createElement(_MenuItem2.default, _extends({}, workItem, { key: key }));
            })), _react2.default.createElement('div', { className: 'menu-divider' }), _react2.default.createElement('div', { className: 'menu-list' }, menuData.app.map(function (appItem, key) {
                return _react2.default.createElement(_MenuItem2.default, _extends({}, appItem, { key: key }));
            })));
        }
    }]);
...
var MenuHeader = function MenuHeader(_ref) {
    var onCloseMobileMenu = _ref.onCloseMobileMenu;

    return _react2.default.createElement('div', { className: 'heading' }, _react2.default.createElement('div', { className: 'heading-mobile-close', id: 'heading-mobile-close', onClick: onCloseMobileMenu }, _react2.default.createElement('svg', { width: '18', height: '13', viewBox: '0 0 18 13' }, _react2.default.createElement('g', { fill: 'none', fillRule: 'evenodd', stroke: '#FFF', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: '1.5' }, _react2.default.createElement('path', { d: 'M1.5 6.5h15M11.5 1.5l5 5-5 5' })))), _react2.default.createElement('div', { className: 'heading-text' }, _react2.default.createElement('a', { href: '/', className: 'heading-link' }, 'Daniel Rasmussen')), _react2.default.createElement('div', { className: 'heading-underline menu-divider' }));
};

MenuHeader.propTypes = {
    onCloseMobileMenu: _propTypes2.default.func.isRequired
};
...
var MenuItem = function MenuItem(_ref) {
    ...
    return _react2.default.createElement('div', { className: 'menu-item' + (addSelectClass() ? ' selected' : '') }, _react2.default.createElement('a', { href: url, className: 'menu-link' }, _react2.default.createElement('div', { className: 'menu-item-name' }, name), _react2.default.createElement('div', { className: 'menu-item-tagline' }, tagline)));
};
...
var ContentMenu = function (_Component) {
    _inherits(ContentMenu, _Component);

    function ContentMenu(props) {
        _classCallCheck(this, ContentMenu);

        var _this = _possibleConstructorReturn(this, (ContentMenu.__proto__ || Object.getPrototypeOf(ContentMenu)).call(this, props));
        ...
        _this.handleMobileMenuClick = function () {
            var mobileMenu = document.getElementById('menu-container');
    ...
    _createClass(ContentMenu, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement('div', { className: 'content-menu-wrapper' }, _react2.default.createElement('div', { className: 'content-mobile-menu-trigger', id: 'content-mobile-menu-trigger', onClick: this.handleMobileMenuClick }, _react2.default.createElement('svg', { width: '16', height: '15', viewBox: '0 0 16 15' }, _react2.default.createElement('g', { fill: 'none', fillRule: 'evenodd' }, _react2.default.createElement('g', { fill: '#D7E4E8', fillRule: 'nonzero' }, _react2.default.createElement('path', { d: 'M0 0h16v3H0zM0 6h16v3H0zM0 12h16v3H0z' }))))), _react2.default.createElement('div', { className: 'content-menu-list clear' }, menuData.contact.map(function (contactItem) {
                if (contactItem.name === 'Contact') {
                    return _react2.default.createElement('a', { key: contactItem.name, href: contactItem.url, className: 'content-menu-link', rel: 'noopener noreferrer' }, contactItem.name);
                }
                return _react2.default.createElement('a', { key: contactItem.name, href: contactItem.url, className: 'content-menu-link', target: '_blank', rel: 'noopener noreferrer' }, contactItem.name);
            })), _react2.default.createElement('div', { className: 'content-menu-underline' }));
        }
    }]);
...
var ContactMenu = function ContactMenu() {
    return _react2.default.createElement('div', { className: 'content-menu-wrapper' }, _react2.default.createElement('div', { className: 'content-menu-list clear' }, _react2.default.createElement('div', { className: 'contact-item item-1of3 left' }, _react2.default.createElement('i', { className: 'contact-item icon' }, _react2.default.createElement('svg', { viewBox: '0 0 512 512' }, _react2.default.createElement('path', { d: 'M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm0 448c-110.5 0-200-89.5-200-200S145.5 56 256 56s200 89.5 200 200-89.5 200-200 200zm61.8-104.4l-84.9-61.7c-3.1-2.3-4.9-5.9-4.9-9.7V116c0-6.6 5.4-12 12-12h32c6.6 0 12 5.4 12 12v141.7l66.8 48.6c5.4 3.9 6.5 11.4 2.6 16.8L334.6 349c-3.9 5.3-11.4 6.5-16.8 2.6z' }))), _react2.default.createElement('span', { className: 'menu-text' }, 'MST')), _react2.default.createElement('div', { className: 'contact-item item-1of3 center' }, 'Contact'), _react2.default.createElement('div', { className: 'contact-item item-1of3 right' }, _react2.default.createElement('i', { className: 'contact-item icon' }, _react2.default.createElement('svg', { viewBox: '0 0 384 512' }, _react2.default.createElement('path', { d: 'M323.1 441l53.9-53.9c9.4-9.4 9.4-24.5 0-33.9L279.8 256l97.2-97.2c9.4-9.4 9.4-24.5 0-33.9L323.1 71c-9.4-9.4-24.5-9.4-33.9 0L192 168.2 94.8 71c-9.4-9.4-24.5-9.4-33.9 0L7 124.9c-9.4 9.4-9.4 24.5 0 33.9l97.2 97.2L7 353.2c-9.4 9.4-9.4 24.5 0 33.9L60.9 441c9.4 9.4 24.5 9.4 33.9 0l97.2-97.2 97.2 97.2c9.3 9.3 24.5 9.3 33.9 0z' }))))), _react2.default.createElement('div', { className: 'content-menu-underline' }));
};

exports.default = ContactMenu;
